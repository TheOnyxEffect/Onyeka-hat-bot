  ...
  return (
    <main>
      <div className="flex flex-col gap-3 items-center">
        <img src="gemini-dark.jpg" alt="gemini logo" className="rounded w-40 mt-5"/>
        <h1 className="font-bold text-6xl text-center pt-5 text-indigo-700">MY CHAT BOT</h1>   
        <h2 className="font-bold text-4xl text-center pt-5 text-indigo-700 text-opacity-25">talk to me ;)</h2>     
      </div>
      <div className="flex flex-col justify-center mt-40 items-center">
          {canStop ? 
            <button className="bg-[#6a9ab6] mt-5 px-3 py-1 rounded-md text-[#fff] hover:bg-[#614cee]" onClick={stopSpeech}>
          ...
          {error && <h3 id="error" className="text-[#fff] m-3 p-2 text-center bg-[#364F6B]">There was an Error. Try again</h3>}
      </div>
    </main>
  );
};
